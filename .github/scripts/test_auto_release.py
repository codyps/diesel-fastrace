...
class PolicyTests(unittest.TestCase):
    ...
    def test_previous_release_controls_timer_not_pr_activity(self):
        releases=[{'draft':False,'prerelease':False,'tag_name':'diesel-fastrace-0.1.0','published_at':'2026-09-01T00:00:00Z'}]
    ...
    def test_fork_is_not_release_pr(self):
        ...
        self.assertFalse(a.release_pr(pr,'codyps/diesel-fastrace','main'))
